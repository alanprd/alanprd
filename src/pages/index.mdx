  ...
  <BaseCard title="Home">
    <div class="flex">
      <div class="p-6">
          ...
          Welcome to my website dedicated to cybersecurity! Here, I share detailed articles on the challenges I complete, with write-ups explaining the solutions and techniques used. You’ll also find posts about my personal projects, where I explore various aspects of computer security. Whether you're passionate about ethical hacking or just curious to learn more, I hope you'll find useful and inspiring resources here.
      </div>
    </div>
